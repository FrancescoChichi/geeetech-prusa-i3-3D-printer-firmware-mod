...
#define HOTEND_OFFSET_X {0.0, 32.4} // (in mm) for each extruder, offset of the hotend on the X axis  0.4
#define HOTEND_OFFSET_Y {0.0, 1.3}  // (in mm) for each extruder, offset of the hotend on the Y axis  1.3
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.42   // Z offset: -below +above  [the nozzle]
